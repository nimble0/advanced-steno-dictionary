...
def print_translation_option_group(option_group):
    for option in option_group:
        if type(option) is str:
            print("(part a)", option)
        elif isinstance(option, PartsList):
            print_advanced_translation(option)

def print_advanced_translation(translation):
    for part in translation:
        if type(part) is str:
            print("(part b)", part)
        else:
            print("[")
            print_translation_option_group(part)
            print("]")
...
#for x in permutate_recursive_indices([[1], [3, [[2, 15]]] , [4]]):
#for x in permutate_recursive([[3],[2, 15]]):
#    print(x)

#for i in permutate([1, [3,[2, 15]] , 4]):
    #print(i)


#for x in permutate_indices([["and", "if", "that"], ["you", "I"], ["can", "know", "would"]]):
    #print(x)

#blah = [["but he", [["and", "if", "that"], ["you", "I"]]], ["can", "know", "would"]]
#for x in permutate_tree_indices(blah):
    #print(x, lookup_tree_sequence(blah, x))
